...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            if number == "q":
                ...
                env.viewer.viewer.lock()
                
                test_object = MJCFObject(
                    name = "table_plates",
                    mjcf_path = os.path.join(current_dir, "table_plates/table_plates.xml"),
                )
                
                env._create_objects([test_object])
            ...
            # env.render() # ! this does not work!

            # if save_xml:                    
            #     with open(os.path.join(current_dir, "scene.xml"), "w") as f:
    ...
    input("Press Enter to reset and rerender...")
